...
public interface AddUserLocal {
  ...
  /*addContactInfo must be called firtst and next either addBidder or addSeller or both*/
  void addContactInfo(String userId,
                                String phone,
                                String email, 
                                String streetname1,
                                String streetname2,
  ...
  void addSeller(String userId,  String firstName, String lastName, String userType,
                    Timestamp birthDate, long maxItemsAllowed, double commissionRate);
  
  void addBidder(String userId, String firstName, String lastName, String userType,
                      long creditRating, Timestamp birthDate,long userBillingId) ;

 void changeBidderStatus( String bidderId, BidderStatus bidderStatus );
