/*Never use both annotations and ejb-jar.xml together with Weblogic 10.3 at the EJB wizard*/
...
@Stateless(name = "BazaarAdmin", mappedName = "ejb3inaction-Chapter10-BazaarAdmin")
  ...
  /* Demonstrates Dynamic Query, Positional Parameter and Single Result */
      ...
      public Category findByFullCategoryName(String categoryName) {
            Query query = em.createQuery(
              ...
              query.setParameter(1,"Junk Cars from Dumpster");         
       ...
       public List getUserWithItemsWithNativeQuery(){
          Query q = em.createNativeQuery("select user_id, first_name, last_name" +
              ...
              "   select seller_id from "
                + "items group by seller_id " +
              "   having count(*) >1)", actionbazaar.persistence.User.class); 
